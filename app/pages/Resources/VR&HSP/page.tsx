  ...
  return (
    <>
      ...
      <div className='xl:container mx-auto md:max-w-4xl max-w-sm w-8/10 relative xl:justify-items-center'>
        <h1 className='text-3xl font-extrabold text-left justify-right mb-10 text-gray-800'>What does the Career Horizons Project do for VR & Health Service Providers? </h1>
        <div className="flex justify-start xl:justify-center mb-10">
        <img 
          src="/Resources/vrshp.jpg" 
