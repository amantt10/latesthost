  ...
  return (
    <>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center gap-8 mb-10 px-4'>
        <img
          src="/members/Madeline.jpg"
          alt="Madeline Castle"
          role="Madeline Castle"
        ...
        <div className='flex flex-col gap-4 w-full max-w-md'>
          ...
          <div>
            ...
            <p>CHP Co-Principal Investigator,
Assistant Professor of Rehabilitation Counseling  </p>
          </div>
          <div>
          ...
          {activeTab === 'education' && (
            <div className="px-2 md:px-6">
              <ul className="list-disc pl-6 md:pl-8">
                <li>B.S., Mississippi State University, Educational Psychology, College of Education </li>
                <li>M.Ed., Auburn University, Clinical Mental Health Counseling, College of Education </li>
                <li>Ph.D., University of South Carolina, Counselor Education and Supervision, College of Education</li>
              </ul>
            </div>
          )}
          {activeTab === 'more' && (
            <div>
              <div className="flex justify-center mt-4">
                <a
                  href="https://www.chef.msstate.edu/directory/mcastle"
                  target="_blank"
