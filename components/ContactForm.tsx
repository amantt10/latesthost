...
export function ContactForm() {
  ...
  return (
    <div className="max-w-xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white">
      <h2 className="font-bold text-4xl text-center text-neutral-800 dark:text-neutral-200 mb-5">
        Referal Contact Information
      </h2>
      <p className="text-neutral-600 text-sm max-w-lg mt-2 dark:text-neutral-300">
        Thank you for visiting our website! Please fill out the form below and we will get back to you as soon as possible.
      </p>
